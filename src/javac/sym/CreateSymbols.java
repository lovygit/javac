...
import javac.api.JavacTaskImpl;
...
import javac.jvm.ClassWriter;
import javac.jvm.Pool;
...
public class CreateSymbols extends AbstractProcessor {
    ...
    static Set<String> getLegacyPackages() {
        ResourceBundle legacyBundle
            = ResourceBundle.getBundle("javac.resources.legacy");
    ...
    void createSymbols() throws IOException {
        ...
        javac.main.JavaCompiler compiler =
            javac.main.JavaCompiler.instance(task.getContext());
