...
import source.util.TaskEvent;
import javac.api.BasicJavacTask;
import javac.api.JavacTrees;
import javac.api.MultiTaskListener;
import javac.code.*;
import javac.code.Symbol.*;
import javac.file.FSInfo;
import javac.file.JavacFileManager;
import javac.jvm.*;
import javac.jvm.ClassReader.BadClassFile;
import javac.main.JavaCompiler;
import javac.model.JavacElements;
import javac.model.JavacTypes;
import javac.parser.*;
import javac.tree.*;
import javac.tree.JCTree.*;
import javac.util.Abort;
import javac.util.Assert;
import javac.util.ClientCodeException;
import javac.util.Context;
import javac.util.Convert;
import javac.util.JCDiagnostic;
import javac.util.JavacMessages;
import javac.util.List;
import javac.util.Log;
import javac.util.Name;
import javac.util.Names;
import javac.util.Options;
import javac.util.ServiceLoader;
import static javac.code.Lint.LintCategory.PROCESSING;
import static javac.main.Option.*;
import static javac.comp.CompileStates.CompileState;
import static javac.util.JCDiagnostic.DiagnosticFlag.*;
