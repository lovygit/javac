...
import javac.main.Main;
import javac.main.Option;
import javac.main.OptionHelper;
import javac.main.OptionHelper.GrumpyHelper;
...
public final class JavacTool implements JavaCompiler {
    ...
    public int run(InputStream in, OutputStream out, OutputStream err, String... arguments) {
        ...
        return javac.Main.compile(arguments, new PrintWriter(err, true));
    }
