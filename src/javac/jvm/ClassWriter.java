...
import javac.code.Types.UniqueType;
import javac.file.BaseFileObject;
import javac.jvm.Pool.DynamicMethod;
import javac.jvm.Pool.Method;
import javac.jvm.Pool.MethodHandle;
import javac.jvm.Pool.Variable;
import javac.util.*;

import static javac.code.Flags.*;
import static javac.code.Kinds.*;
import static javac.code.TypeTag.*;
import static javac.jvm.UninitializedType.*;
