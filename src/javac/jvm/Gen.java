...
import javac.jvm.Code.*;
import javac.jvm.Items.*;
...
import static javac.jvm.ByteCodes.*;
import static javac.jvm.CRTFlags.*;
 ...
 *************************************************************************/
    ...
    private void setTypeAnnotationPositions(int treePos) {
        ...
        for (Symbol s : new javac.model.FilteredMemberList(clazz.members())) {
