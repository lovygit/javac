...
import static javac.code.TypeTag.BOOLEAN;
import static javac.code.TypeTag.VOID;
...
public class Flow {
    ...
    class FlowAnalyzer extends BaseAnalyzer<FlowAnalyzer.FlowPendingExit> {
        ...
        class FlowPendingExit extends javac.comp.Flow.BaseAnalyzer.PendingExit {
    ...
    public class AssignAnalyzer extends BaseAnalyzer<AssignAnalyzer.AssignPendingExit> {
        ...
        public class AssignPendingExit extends javac.comp.Flow.BaseAnalyzer.PendingExit {
