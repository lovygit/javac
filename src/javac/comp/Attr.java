...
import source.tree.IdentifierTree;
import source.tree.MemberReferenceTree.ReferenceMode;
import source.tree.MemberSelectTree;
import source.tree.TreeVisitor;
import source.util.SimpleTreeVisitor;
import javac.code.*;
import javac.code.Lint.LintCategory;
...
import static javac.code.Flags.ANNOTATION;
...
import static javac.code.TypeTag.WILDCARD;
...
//                             Resolve.isStatic(env));//DEBUG
    ...
    private final class TypeAnnotationsValidator extends TreeScanner {
         ...
         * javac.comp.Check.Validator.visitSelectInternal(JCFieldAccess)
