...
import javac.api.DiagnosticFormatter;
import javac.api.DiagnosticFormatter.Configuration.DiagnosticPart;
import javac.api.DiagnosticFormatter.Configuration.MultilineLimit;
import javac.api.DiagnosticFormatter.PositionKind;
import javac.api.Formattable;
import javac.code.Lint.LintCategory;
import javac.code.Printer;
import javac.code.Symbol;
import javac.code.Type;
import javac.code.Type.CapturedType;
import javac.file.BaseFileObject;
import javac.jvm.Profile;
import javac.tree.JCTree.*;
import javac.tree.Pretty;
import static javac.util.JCDiagnostic.DiagnosticType.*;
