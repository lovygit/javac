...
import javac.code.Attribute.TypeCompound;
import javac.code.Type.AnnotatedType;
import javac.code.Type.ArrayType;
import javac.code.Type.CapturedType;
import javac.code.Type.ClassType;
import javac.code.Type.ErrorType;
import javac.code.Type.ForAll;
import javac.code.Type.MethodType;
import javac.code.Type.PackageType;
import javac.code.Type.TypeVar;
import javac.code.Type.UndetVar;
import javac.code.Type.Visitor;
import javac.code.Type.WildcardType;
import javac.code.TypeAnnotationPosition.TypePathEntry;
import javac.code.TypeAnnotationPosition.TypePathEntryKind;
import javac.code.Symbol.VarSymbol;
import javac.code.Symbol.MethodSymbol;
import javac.comp.Annotate;
import javac.comp.Annotate.Worker;
...
import javac.tree.JCTree.JCBlock;
import javac.tree.JCTree.JCClassDecl;
import javac.tree.JCTree.JCExpression;
import javac.tree.JCTree.JCLambda;
import javac.tree.JCTree.JCMethodDecl;
import javac.tree.JCTree.JCMethodInvocation;
import javac.tree.JCTree.JCNewClass;
import javac.tree.JCTree.JCTypeApply;
import javac.tree.JCTree.JCVariableDecl;
import javac.tree.TreeScanner;
import javac.tree.JCTree.*;
...
public class TypeAnnotations {
    ...
    private class TypeAnnotationPositions extends TreeScanner {
        ...
        // {@link javac.parser.JavacParser.insertAnnotationsToMostInner(JCExpression, List<JCTypeAnnotation>, boolean)}
        ...
        private Type typeWithAnnotations(final JCTree typetree, final Type type,
            ...
            if (type.hasTag(TypeTag.ARRAY)) {
                ...
                // UnionClassType uct = (javac.code.Type.UnionClassType)type;
        ...
        private void resolveFrame(JCTree tree, JCTree frame,
            ...
            */
            ...
            // javac.jvm.Gen.setTypeAnnotationPositions(int)
