...
import javac.code.Attribute.RetentionPolicy;
import javac.code.Lint.LintCategory;
import javac.code.Type.UndetVar.InferenceBound;
import javac.comp.AttrContext;
import javac.comp.Check;
import javac.comp.Enter;
import javac.comp.Env;
import javac.jvm.ClassReader;
import javac.tree.JCTree;
import javac.util.*;
import static javac.code.BoundKind.*;
import static javac.code.Flags.*;
import static javac.code.Kinds.MTH;
import static javac.code.Scope.*;
import static javac.code.Symbol.*;
import static javac.code.Type.*;
import static javac.code.TypeTag.*;
import static javac.jvm.ClassFile.externalize;
