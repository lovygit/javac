...
import source.doctree.AttributeTree.ValueKind;
import javac.parser.DocCommentParser.TagParser.Kind;
import javac.parser.Tokens.Comment;
import javac.parser.Tokens.TokenKind;
import javac.tree.DCTree;
import javac.tree.DCTree.DCAttribute;
import javac.tree.DCTree.DCDocComment;
import javac.tree.DCTree.DCEndElement;
...
import javac.tree.DCTree.DCStartElement;
import javac.tree.DCTree.DCText;
import javac.tree.DocTreeMaker;
import javac.tree.JCTree;
import javac.util.DiagnosticSource;
...
import static javac.util.LayoutCharacters.*;
...
public class DocCommentParser {
    ...
    private void initTagParsers() {
        TagParser[] parsers = {
            ...
            // {@code text}
            new TagParser(TagParser.Kind.INLINE, DCTree.Kind.CODE) {
            ...
            // {@literal text}
            new TagParser(TagParser.Kind.INLINE, DCTree.Kind.LITERAL) {
                public DCTree parse(int pos) throws ParseException {
                    DCTree text = inlineText();
                    nextChar();
