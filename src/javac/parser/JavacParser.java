...
import javac.code.*;
import javac.parser.Tokens.*;
import javac.parser.Tokens.Comment.CommentStyle;
import javac.tree.*;
...
import static javac.parser.Tokens.TokenKind.*;
import static javac.parser.Tokens.TokenKind.ASSERT;
import static javac.parser.Tokens.TokenKind.CASE;
import static javac.parser.Tokens.TokenKind.CATCH;
import static javac.parser.Tokens.TokenKind.EQ;
import static javac.parser.Tokens.TokenKind.GT;
import static javac.parser.Tokens.TokenKind.IMPORT;
import static javac.parser.Tokens.TokenKind.LT;
        ...
        if (token.kind == LBRACKET || token.kind == MONKEYS_AT) {
            ...
            if (newClass.def != null) {
                ...
                if (newAnnotations.nonEmpty()) {
                    ...
                    // javac.code.TypeAnnotations.TypeAnnotationPositions.visitNewClass(JCNewClass)
