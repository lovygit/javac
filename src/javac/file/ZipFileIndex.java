...
import javac.file.RelativePath.RelativeDirectory;
import javac.file.RelativePath.RelativeFile;
...
public class ZipFileIndex {
     ...
     */
    public synchronized javac.util.List<String> getFiles(RelativeDirectory path) {
        try {
            checkIndex();

            DirectoryEntry de = directories.get(path);
            javac.util.List<String> ret = de == null ? null : de.getFiles();

            if (ret == null) {
                return javac.util.List.<String>nil();
            }
            return ret;
        }
        catch (IOException e) {
    ...
    public synchronized List<String> getDirectories(RelativeDirectory path) {
        try {
            ...
            DirectoryEntry de = directories.get(path);
            javac.util.List<String> ret = de == null ? null : de.getDirectories();
   ...
   */
    ...
    static class DirectoryEntry {
        ...
        private javac.util.List<String> zipFileEntriesFiles = javac.util.List.<String>nil();
        private javac.util.List<String> zipFileEntriesDirectories = javac.util.List.<String>nil();
        private javac.util.List<Entry>  zipFileEntries = javac.util.List.<Entry>nil();
        ...
        private javac.util.List<String> getFiles() {
            if (!filesInited) {
                initEntries();
                for (Entry e : entries) {
                    if (!e.isDir) {
        ...
        private javac.util.List<String> getDirectories() {
        ...
        private javac.util.List<Entry> getEntries() {
            if (!zipFileEntriesInited) {
                initEntries();
                zipFileEntries = javac.util.List.nil();
